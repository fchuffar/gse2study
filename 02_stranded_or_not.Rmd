...
foo_no = read.table(paste0("~/projects/datashare/", gse, "/", gsm, "_notrim_star_", species, "_", version, "_geneswchrm_strandedno_classiccounts.txt"     ))[,2]
foo_re = read.table(paste0("~/projects/datashare/", gse, "/", gsm, "_notrim_star_", species, "_", version, "_geneswchrm_strandedreverse_classiccounts.txt"))[,2]
foo_ye = read.table(paste0("~/projects/datashare/", gse, "/", gsm, "_notrim_star_", species, "_", version, "_geneswchrm_strandedyes_classiccounts.txt"    ))[,2]
