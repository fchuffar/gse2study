...
# foo_no = read.table(paste0("~/projects/", datashare, "/", gse, "/", gsm, "_notrim_star_", species, "_", version, "_", gtf_prefix, "_strandedno_classiccounts.txt"     ))[,2]
foo_re = read.table(paste0("~/projects/", datashare, "/", gse, "/", gsm, "_notrim_star_", species, "_", version, "_", gtf_prefix, "_strandedreverse_classiccounts.txt"))[,2]
foo_ye = read.table(paste0("~/projects/", datashare, "/", gse, "/", gsm, "_notrim_star_", species, "_", version, "_", gtf_prefix, "_strandedyes_classiccounts.txt"    ))[,2]
