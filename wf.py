...
rule target:
    ...
    input: 
      ...
      unmaptelocentro_GSE100469 = get_files("/bettik/fchuffar/datashare/GSE100469", "_notrim_fqgz.info", "/bettik/fchuffar/datashare/GSE100469", "_telocentro.unmapblasted.txt.gz"),
