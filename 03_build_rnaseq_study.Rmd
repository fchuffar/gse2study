...
study_filename = paste0("study_", gse, "_", version, ".rds")
```
...
count_files = list.files(paste0("~/projects/datashare/", gse), paste0("notrim_star_", species, "_", annotation, "_", version, "_", gtf_prefix, "_stranded", strand, "_classiccounts.txt"), full.names=TRUE)  
