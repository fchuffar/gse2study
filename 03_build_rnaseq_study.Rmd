...
count_files = list.files(paste0("~/projects/datashare/", gse), paste0("notrim_star_", species, "_", version, "_geneswchrm_strandedreverse_classiccounts.txt"), full.names=TRUE)  
