...
count_files = list.files(paste0("~/projects/datashare/", gse), paste0("notrim_star_", species, "_", version, "_", gtf_prefix, "_stranded", strand, "_classiccounts.txt"), full.names=TRUE)  
