...
# srr = "SRR1274638"
# foo_no = read.table(paste0("~/projects/datashare/", gse, "/", srr, "_notrim_star_Homo_sapiens_hg19_geneswchrm_strandedno_classiccounts.txt"     ))[,2]
# foo_re = read.table(paste0("~/projects/datashare/", gse, "/", srr, "_notrim_star_Homo_sapiens_hg19_geneswchrm_strandedreverse_classiccounts.txt"))[,2]
# foo_ye = read.table(paste0("~/projects/datashare/", gse, "/", srr, "_notrim_star_Homo_sapiens_hg19_geneswchrm_strandedyes_classiccounts.txt"    ))[,2]
# plot(log2(foo_re), log2(foo_ye))
# abline(0,1, col=2)
...
exp_grp_mqc = read.table("multiqc_notrim_data/multiqc_star.txt", sep="\t", header=TRUE, stringsAsFactors=FALSE)
